...
@synthesize width=__width, badgeString=__badgeString, parent=__parent, badgeColor=__badgeColor;
@synthesize badgeTextColor=__badgeTextColor, badgeColorHighlighted=__badgeColorHighlighted;
@synthesize showShadow=__showShadow, boldFont=__boldFont, radius=__radius;
@synthesize badgeTextColorHighlighted = __badgeTextColorHighlighted;
...
@synthesize badgeString=__badgeString, badge=__badge, badgeColor, badgeTextColor, badgeColorHighlighted;
@synthesize showShadow, badgeLeftOffset, badgeRightOffset, resizeableLabels, badgeTextColorHighlighted;
...
- (void) layoutSubviews {
	...
	if (self.badgeString) {
        ...
        CGSize badgeSize = badgeSize = [self.badgeString sizeWithAttributes:@{ NSFontAttributeName:font }];
